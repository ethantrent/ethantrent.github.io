...
export const projects: Project[] = [
  {
    id: "u2-kbxcom",
    name: "U2 — Unified Property/Billing SaaS (KBXCOM)",
    year: "2025",
    category: "Full-stack product",
    description: [
      "Co-built U2 for the Unified Property/Billing SaaS, targeting a $340M serviceable market.",
    ...
    imageSrc: "/u2.png",
    imageAlt: "U2 Unified Property/Billing SaaS logo",
