/**
 * Shared editorial component classes — single source of truth so buttons,
 * cards, and eyebrows stay consistent across pages.
 */

export const buttonPrimary =
  "inline-flex min-h-11 cursor-pointer items-center justify-center gap-2 rounded-md bg-accent px-5 py-2.5 text-sm font-medium text-white transition duration-200 hover:bg-accent/85 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent";

export const buttonSecondary =
  "inline-flex min-h-11 cursor-pointer items-center justify-center gap-2 rounded-md border border-hairline bg-surface px-5 py-2.5 text-sm font-medium text-fg transition duration-200 hover:border-hairline-strong hover:bg-surface-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent";
